...
public class ErrorEndpoint {
    ...
    public void processErrorEvent( Message<Sample> message ) {
        log.debug( "processErrorEvent : enter" );

        log.error( "processErrorEvent : sample=" + message.getPayload().toString() );

        log.debug( "processErrorEvent : exit" );
    }
